...
export declare class DynamicColor {
     ...
     * constructed.
     */
    constructor(name: string, palette: (scheme: DynamicScheme) => TonalPalette, tone: (scheme: DynamicScheme) => number, isBackground: boolean, background?: ((scheme: DynamicScheme) => DynamicColor) | undefined, secondBackground?: ((scheme: DynamicScheme) => DynamicColor) | undefined, contrastCurve?: ContrastCurve | undefined, toneDeltaPair?: ((scheme: DynamicScheme) => ToneDeltaPair) | undefined);
    /**
